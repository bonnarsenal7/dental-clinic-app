...
export default function VisitBilling({
  ...
  if (!invoice) {
    return <p className="text-sm text-slate-400 mt-2">Nothing billed for this visit.</p>
  }
  ...
  if (invoice.status === 'draft') {
    ...
    return <p className="text-sm text-slate-400 mt-2">The dentist is still adding to this visit's bill.</p>
  }
